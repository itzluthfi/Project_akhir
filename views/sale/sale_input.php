...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <form action="MainEntryPoint.php?modul=sale&fitur=add" method="POST" id="transaksiForm">
                <div class="mb-4">
                    <label for="customer" class="block text-gray-700">Customer</label>
                    <select id="customer" name="customer" class="mt-1 p-2 border border-gray-300 rounded w-1/3"
                        required>
...
//                                    ];
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]"
                                    class="mt-1 p-2 border border-gray-300 rounded w-full" min="1" required>
                            </div>
                            <div>
                                <button type="button"
                                    class="mt-6 bg-red-500 text-white p-2 rounded remove-item">Hapus</button>
                            </div>
                        </div>
                    </div>
                </div>
                <button type="button" id="addBarangBtn" class="bg-blue-500 text-white p-2 rounded mt-2">Tambah
                    Barang</button>
                <div class="mt-6">
